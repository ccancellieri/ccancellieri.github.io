# Carlo Cancellieri — CV Tailoring Strategy
...
- B.A.Sc. in IT Management
- OGC membership and ISO-TC211 contribution (prominently, in the profile paragraph)
...
- QAR scores in external CVs (use in FAO internal documents and self-assessments only)
...
- Hand-in-Hand Initiative by name
- Cloud platform management and data governance
- MBA with ESG/ethical AI thesis (aligns with UN values)

**Title shown:** Lead Software Engineer — Geospatial & Data Systems
**Important:** Carlo's actual title is Lead Software Engineer, NOT Information Technology Officer. The CV targets an Officer role, but must not claim a title he doesn't hold.

**Include:** All FAO work (2020–present, 2015–2017), GeoSolutions (shows geospatial depth), GSoC
**Omit:** Algo trading, teaching, freelance electronics
...
- Java (17+ years) and Python as dual primary languages

**Include:** All technical roles
**Omit:** Algo trading, teaching
...
**Include:** Everything including teaching
**Omit:** Algo trading unless client is in fintech
...
- Product ownership at GeoSolutions
- Stakeholder management across FAO divisions
- MBA qualification

**Include:** All roles with management angle emphasized
**Omit:** Algo trading, teaching, deep technical minutiae
...
**Include:** All technical roles with AI angle
**Omit:** Algo trading, teaching
...
**Include:** Everything including pre-career electronics/DJ work and algo trading
**Omit:** Nothing — this variant celebrates the full journey
...
- OGC standards-compliant geospatial UIs
- User-facing product experience

**Include:** All roles with frontend angle
**Omit:** Algo trading, teaching, deep backend/infrastructure details
